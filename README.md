...
<br />
<div align="center">
  <a href="https://github.com/udabasili/unshelled_web">
...
Here's a blank template to get started: To avoid retyping too much info. Do a search and replace with your text editor for the following: `udabasili`, `unshelled_web`, `twitter_handle`, `linkedin_username`, `yahoo`, `udbasili`, `unshelled web app`,
...
2. Clone the repo
   ...
   ```sh
   git clone https://github.com/udabasili/unshelled_web.git
   ```
...
See the [open issues](https://github.com/udabasili/unshelled_web/issues) for a full list of proposed features (and known issues).
